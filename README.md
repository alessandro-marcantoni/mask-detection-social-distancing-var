...
You will need to download and unzip the [```facemask-detection-resources.zip```](https://drive.google.com/file/d/1l2Og7dbc_yPW0s63hwIZxN2K8gJgxH69/view?usp=sharing) archive in the ```mask-detection``` folder. It contains:
